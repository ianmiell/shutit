...
class ipython(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.install('openssh-server git-core libxml2-dev curl python build-essential make gcc python-dev wget libsqlite3-dev sqlite3')
		...
		shutit.install('libfreetype6 libfreetype6-dev')
		shutit.install('python-imaging libpng-dev')
		shutit.install('libzmq-dev')
