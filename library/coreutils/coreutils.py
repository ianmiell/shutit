...
def module():
	return coreutils(
		...
		description='',
		maintainer='',
		depends=['shutit.tk.git.git','shutit.tk.bison.bison','shutit.tk.gperf.gperf','shutit.tk.patch.patch','shutit.tk.rsync.rsync','shutit.tk.libxslt.libxslt','shutit.tk.texinfo.texinfo']
	)
