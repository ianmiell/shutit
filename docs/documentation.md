...
used by "Check ready" part of lifecycle to determine whther the module is installed or 
...
handles the starting of the module

- stop

handles the stopping of the module

- test

handles the testing of the module - returns True if all is ok, else False

- get_config

gathers config for the module
...
Help on module shutit_global:

(export PAGER=cat; python; import shutit_global; help(shutit_global))
