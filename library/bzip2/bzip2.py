...
class bzip2(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send_host_file('/opt/bzip2/bzip2.tar','context/bzip2-' + shutit.cfg[self.module_id]['version'] + '.tar')
		shutit.send('tar -xf bzip2.tar')
		shutit.send('pushd bzip2-' + shutit.cfg[self.module_id]['version'])
